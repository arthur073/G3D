...
void LightsMaterials::setLightPosition()
{
  light1_position[0] = fmod(light1_position[0]+0.1f,10.0f);
  light1_position[1] = fmod(light1_position[1]+0.3f,10.0f);
  light1_position[2] = fmod(light1_position[2]+0.4f,10.0f);
  light1_position[3] = fmod(light1_position[3]+0.8f,10.0f);
	glLightfv(GL_LIGHT1, GL_POSITION, light1_position); 
